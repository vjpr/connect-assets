...
(function() {
  var BEFORE_DOT, ConnectAssets, EXPLICIT_PATH, REMOTE_PATH, Snockets, connectCache, crypto, cssCompilers, cssExts, debug, exports, fs, getExt, jsCompilers, libs, logger, md5Filenamer, mkdirRecursive, parse, path, stripExt, timeEq, _,
    __slice = [].slice,
  ...
  module.exports = exports = function(options) {
    ...
    return connectAssets.compileIfChanged;
  };
  ...
  ConnectAssets = (function() {
    ...
    function ConnectAssets(options) {
      ...
      this.compileIfChanged = __bind(this.compileIfChanged, this);
    ...
    ConnectAssets.prototype.compileIfChanged = function(req, res, next) {
      var route;
      if (req.method !== 'GET') {
        return next();
      }
      ...
      try {
        this.compileCSS(route.slice(1));
      } catch (_error) {}
      try {
        this.compileJS(route.slice(1));
      } catch (_error) {}
      return this.cache.middleware(req, res, next);
    };
